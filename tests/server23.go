...
<head>
	...
	<!--  <script src="http://localhost:8080/static/PruneCluster.js"></script> これ、いずれローカルホストから取れるように換える(のは無理そう→goのサーバの立ち上がりに間に合わない？) --> 
	<!--  <link rel="stylesheet" href="http://localhost:8080/static/examples.css"/> これも、いずれローカルホストから取れるように換える→goのサーバの立ち上がりに間に合わない？ --> 


	<!-- goのテンプレートのローカルって、どこになるんだろう？
	 → 解決した https://wp.kobore.net/%e6%b1%9f%e7%ab%af%e3%81%95%e3%82%93%e3%81%ae%e6%8a%80%e8%a1%93%e3%83%a1%e3%83%a2/post-5280/-->
